...
public class RoleEntity  extends IdEntity<Long> {
    ...
    @JoinTable(name = "role_res", joinColumns = { @JoinColumn(name = "role_id", nullable = false, updatable = false) }, inverseJoinColumns = { @JoinColumn(name = "res_id", nullable = false, updatable = false) })
